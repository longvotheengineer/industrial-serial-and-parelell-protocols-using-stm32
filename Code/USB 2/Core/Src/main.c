...
void ProcessRxBuffer(void)
{
    if (strcmp((char*)Rx_Buffer, "00000000011") == 0) 
    {
        HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13, GPIO_PIN_SET); // T?t LED (LED OFF)
    ...
    {
        HAL_GPIO_WritePin(GPIOC, GPIO_PIN_13, GPIO_PIN_RESET); // B?t LED (LED ON)
