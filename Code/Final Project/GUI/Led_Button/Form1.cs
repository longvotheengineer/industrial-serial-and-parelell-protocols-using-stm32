...
namespace Led_Button
{
    public partial class Form1: Form
    {
        ...
        private void GetVidPidFromComPort(string portName)
        {
                        ...
                        if (name != null && name.Contains(portName)) 
                        {
                            ...
                            if (deviceId != null)
                            {
                                ...
                                if (match.Success)
                                {
                                    ...
                                    txtVID.Text = vidDecimal.ToString();   // gán vào textbox VID
                                    txtPID.Text = pidDecimal.ToString();  // gán vào textbox PID
                                    return;
                                }
                            }
                        }
            ...
            {
                MessageBox.Show("Không thể lấy VID/PID:\n" + ex.Message);
            }
        }
    }
}
